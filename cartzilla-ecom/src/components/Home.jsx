...
const Home = () => {
  return (
    <>
      <Navbar />
      <div className="container mt-26 px-4">
        ...
        <div className="bg-gradient-to-r from-[#ACCBEE] to-[#E7F0FD] dark:bg-gradient-to-r dark:from-[#1B273A] dark:to-[#1F2632] p-4 h-[530px] rounded-2xl  mt-14 grid grid-cols-1  justify-items-center">
          ...
          <p className="font-bold uppercase text-2xl text-center px-4 mt-4">
      ...
      <div className="bg-[#F5F7FA] dark:bg-[#222934] mt-16 pt-12 lg:grid lg:grid-cols-2">
        <div className=" lg:flex lg:flex-col lg:items-center lg:mt-10">
          <p className="font-semibold text-[#181D25] text-2xl ml-4 lg:-ml-14 lg:text-left">
            Sign up to our newsletter
          </p>
          <p className="text-sm text-[#4E5562] mt-2 pr-20 lg:pr-0 ml-4 lg:ml-16 lg:text-left">
